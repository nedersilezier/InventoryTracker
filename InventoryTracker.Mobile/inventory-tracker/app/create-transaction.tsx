...
import { CreateTransactionHeader } from "../components/create-transaction/CreateTransactionHeader";
import { GeneralStep } from "../components/create-transaction/GeneralStep";
import { ItemsStep } from "../components/create-transaction/ItemsStep";
import { ReviewStep } from "../components/create-transaction/ReviewStep";
import { SearchPickerModal } from "../components/create-transaction/SearchPickerModal";
import {
  createTransaction,
  getClientsLookup,
  getItemsLookup,
...
export default function CreateTransactionScreen() {
  ...
  // fromId/toId are generic UI fields and are mapped to backend-specific IDs when building the final request body
  ...
  const submit = async () => {
    ...
    try {
      ...
      Alert.alert("Create transaction error", message);
    } finally {
      setSubmitting(false);
    }
  };
